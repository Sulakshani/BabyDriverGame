...
import "../styles/levelSelection2.css";
...
import level2 from "../assets/levelselection/active.png";
import level3 from "../assets/levelselection/lock.png";
import level4 from "../assets/levelselection/lock.png";

function LevelSelection2() {
  return (
    <div className="level-selection">
      <img alt="menu" src={menu} className="menu-image" />
      <img alt="idle" src={idle} className="idle-2-image" />
      <Link to="/level1" className="start-game">
        <img alt="level-1-active" src={level1} className="level-1-image" />
      </Link>

      <Link to="/level2" className="start-game">
        <img alt="level-2" src={level2} className="level-2-a-image" />
      </Link>
...
export default LevelSelection2;
